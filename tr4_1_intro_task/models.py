...
class Constants(BaseConstants):
    name_in_url = 'tr4_intro_task'
    players_per_group = None
    num_rounds = 1
    IMAGE_EXTENTION = 'png'
    data = pd.read_csv("supporter_upload_s76.csv", delimiter=",", encoding="latin1")
...
class Subsession(BaseSubsession):
    def creating_session(self):
        treat = itertools.cycle(['verbal_only', 'verbal_only_b', 'verbal_idea_b', 'no_info'])
